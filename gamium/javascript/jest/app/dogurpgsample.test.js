...
test("Create Account", async () => {
  const result = await ui.tryFind(
    By.path("/Canvas[1]/Start[1]/DeleteAccountButton[1]")
  );
  ...
  await ui.setText(
    By.path("/Canvas[1]/Register[1]/InputField[1]"),
...
test("Create Character", async () => {
  await ui.click(
    By.path(
      "/Canvas[1]/SelectCharacter[1]/RightPanel[1]/CharacterScrollView[1]/Viewport[1]/Content/SquareButton(Clone)[1]"
    )
  );
  await ui.click(
    By.path(
      "/Canvas[1]/CreateCharacter[1]/RightPanel[1]/CharacterScrollView[1]/Viewport[1]/Content[1]/SquareButton(Clone)[2]"
    )
  );
  await ui.setText(
    By.path(
      "/Canvas[1]/CreateCharacter[1]/RightPanel[1]/NicknamePanel[1]/InputField[1]"
    ),
    Math.random().toString(36).substring(2, 11)
  );
  await ui.click(
    By.path(
      "/Canvas[1]/CreateCharacter[1]/RightPanel[1]/NicknamePanel[1]/OkButton[1]"
    )
  );
  await ui.click(
    By.path("/Canvas[1]/SelectCharacter[1]/RightPanel[1]/StartBtn[1]")
  );
});
